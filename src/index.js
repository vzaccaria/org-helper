...
let entry = (filename) => {
    ...
    let boxPlot = (filename, data, opts, fun) => {
        /* This expects and array of objects { variable: x, value: y } */
        /* You can also use melt to preprocess; in that case, you should specify a different factor */
        if(_.isUndefined(fun)) {
            fun = (x) => x;
    ...
    let dens = (filename, data, opts, fun) => {
        /* This expects and array of objects { variable: x, value: y } */
        /* You can also use melt to preprocess; in that case, you should specify a different factor */
        if(_.isUndefined(fun)) {
            fun = (x) => x;
    ...
    _.mixin({
        concat, histo, filtEq, filtIndex, getOdd, getEven, cor, example, exampleTable, box, dist, boxPlot, dens
    });
    return {
        _, data, R
    };
